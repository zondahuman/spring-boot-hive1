package com.abin.lee.spring.boot.hive.test;

import com.abin.lee.spring.boot.hive.common.util.HttpClientUtil;
 ...
 */
public class HiveDropTest {
    private static final String httpURL = "http://localhost:8099/hive/delete";

    @Test
    public void testHiveDrop() {
        try {
